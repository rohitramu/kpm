...
2. To push your package to a [Docker registry](#docker), ensure that you have the credentials to do so by first logging in.  For example, to get credentials for your Docker Hub account, run:
```
